...
# committed mock-world infra/.env, so no env is injected here. The shared seam
# installs the script's single EXIT trap — later stages extend cleanup via
# cp_cleanup_paths, not re-trap.
