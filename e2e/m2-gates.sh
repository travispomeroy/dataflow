...
# Stage-1 jar, refuse a squatter on 8085, poll the catalog for readiness. The
# seam owns the script's single EXIT trap; Stage 5's temp paths join its
# cleanup via cp_cleanup_paths instead of a second trap.
